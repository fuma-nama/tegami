...
Tegami discovers npm workspace packages automatically, see [Plugins](/plugins) for other languages. Use the `packages` option to override release settings per package.
