...
Create one MR per `groups` entry, unlisted packages get an `unlisted` MR. Accepts [package groups](/package-groups), package names and IDs.
...
<Callout type='warn' title="Avoid branch conflicts">
